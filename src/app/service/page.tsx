        ...
        <div className="-mt-[82px] flex-grow overflow-x-hidden lg:-mt-[106px]">
              ...
              <div className="grid items-center gap-5 md:gap-10 lg:grid-cols-2">
                <div className="heading text-center ltr:lg:text-left rtl:lg:text-right">
                  ...
                  <p className="pt-5 text-lg font-semibold">
                    ...
                    create our business process models. There are many
                ...
                <div className="grid gap-4 rounded-[32px] sm:grid-cols-2 sm:gap-0">
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(130.61deg, #ff416c 0%, #ff4b2b 100%)",
                    }}
                    data-aos="fade-up"
                    data-aos-duration={1000}
                  >
                    ...
                    <div>
                      <h3 className="pb-2 text-lg font-extrabold">
                        Analysis &amp; Planning
                      </h3>
                      <p className="text-sm font-bold leading-5 opacity-80 line-clamp-6">
                        The very first step that we follow while developing apps
                        or working on any project, begins with analysis.
                      </p>
                    </div>
                  </div>
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(130.61deg, #ffbd11 0%, #ff8e00 100%)",
                    }}
                    data-aos="fade-up"
                    data-aos-duration={1000}
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold leading-5 opacity-80 line-clamp-6">
                        Designing helps us understand the engagement of users if
                        the product is user-friendly, intuitive, and reciprocal.
                      </p>
                    </div>
                  </div>
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(130.61deg, #38ef7d 0%, #11998e 100%)",
                    }}
                    data-aos="fade-up"
                    data-aos-duration={1000}
                  >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(130.61deg, #56ccf2 0%, #2f80ed 100%)",
                    }}
                    data-aos="fade-up"
                    data-aos-duration={1000}
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold leading-5 opacity-80 line-clamp-6">
                        Testing is obligatory to an app’s future success; it
                        surrounds a significant section of our overall mobile
          ...
          <section className="overflow-x-hidden bg-gradient-to-t from-white/[55%] to-transparent dark:bg-none md:py-14 lg:pb-[100px] lg:pt-[130px]">
            <div className="relative bg-center">
              ...
              />
              <div className="absolute -inset-x-4 bottom-0 h-12 -rotate-[2deg] bg-[#7780A1]/10 xl:bottom-3" />
          ...
          <div
            id="work-video"
            style={{ display: "none" }}
            className="w-[960px] max-w-full bg-black p-4 dark:bg-gray-dark"
          >
                          ...
                          <g clipPath="url(#clip0_298_1769)">
                            ...
                            <g mask="url(#mask0_298_1769)">
                              ...
                              <circle
                                ...
                                cy="32.6639"
                                r="12.4449"
                                transform="rotate(-22 22.1375 32.6639)"
                                fill="#47BDFF"
                              />
                              <circle
                                cx="-2.6629"
                                cy="22.1365"
                                r="12.4449"
                                transform="rotate(-22 -2.6629 22.1365)"
                                fill="#B476E5"
                              />
                              <circle
                                cx="32.337"
                                cy="7.05449"
                                r="12.4449"
                                transform="rotate(-22 32.337 7.05449)"
                                fill="#B476E5"
                              />
                            </g>
                          </g>
          ...
          <section className="relative bg-black py-14 dark:bg-transparent lg:py-[100px]">
                        ...
                        <div className="col-span-2">
                          <div className="relative rounded-3xl bg-white/[0.02] p-6">
                            ...
                            <p className="relative font-medium italic text-white">
                              ...
                              randomised words which look even slightly
                              believable.
                              <span className="absolute -top-2 ltr:-left-2 rtl:-left-2">
                                <svg
                                  width={100}
                                  height={73}
                                  viewBox="0 0 100 73"
          ...
          <section className="relative overflow-x-hidden border-t-2 border-transparent px-4 py-14 dark:border-gray/20 lg:py-[100px]">
            <div className="items-center justify-center gap-10 lg:flex">
              ...
              >
                ...
                <form
                  action=""
                  className="relative z-[1] text-center lg:pt-[50px]"
                >

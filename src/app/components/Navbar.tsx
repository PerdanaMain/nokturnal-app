...
const Navbar = () => {
  ...
  return (
    <header
      id="top-header"
      className="sticky top-0 z-50 bg-black/10 transition duration-300"
    >
      <div className="container">
        <div className="relative flex items-center justify-between py-5 lg:py-0">
          <a href="/">
          ...
          <div className="flex items-center">
            <div
              ...
              className={`overlay ${
                isMenuOpen ? "hidden" : ""
              } fixed inset-0 z-[51] hidden bg-black/60 lg:hidden`}
            />
            <div className={`menus ${isMenuOpen ? "open-menus" : ""}`}>
              ...
              <ul>
                ...
                <li className="group relative">
                  <a
                    href="javascript:;"
                    className={pathname == "/pages" ? "active" : ""}
                  >
                    Pages
                    <div className="group-hover:rotate-180 ltr:ml-2 rtl:mr-2">
                      <svg
                        width={24}
                        height={24}
                        viewBox="0 0 24 24"
                ...
                <li
                  className={`search-bar ${
                    isSearchOpen ? "open-search-bar" : ""
                  } absolute hidden w-0 overflow-hidden bg-black transition-all duration-500 ltr:right-0 rtl:left-0 lg:block`}
                >
              ...
              <li>
                ...
                >
                  ...
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="light-mode-btn hidden"
                  >
                    <path

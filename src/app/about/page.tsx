    ...
    <>
      ...
      <div className="flex min-h-screen flex-col bg-white bg-gradient-to-r from-[#FCF1F4] to-[#EDFBF9] font-mulish text-base font-normal text-gray antialiased dark:bg-[#101926] dark:from-transparent dark:to-transparent">
        ...
        <div className="-mt-[82px] flex-grow overflow-x-hidden lg:-mt-[106px]">
          <div className="bg-[url(../images/inner-page-hero-bg.png)] bg-cover bg-bottom bg-no-repeat pt-[82px] lg:pt-[106px]">
                ...
                <div className="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M264.628 174.019L261.653 176.584L259.051 165.542L264.628 174.019Z"
                        fill="#47BDFF"
                      />
                      <path
                ...
                <div data-aos="fade-up" data-aos-duration={1000}>
                  <div className="group flex cursor-pointer items-baseline rounded-3xl border border-white bg-white py-8 px-6 transition duration-500 hover:border-secondary hover:bg-secondary/10 dark:border-transparent dark:bg-gray-dark dark:hover:bg-secondary">
                    ...
                    <div className="ltr:pl-4 rtl:pr-4">
                      <h4
                        className="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black"
          ...
          <section className="relative pt-14 lg:pb-48 lg:pt-[100px]">
            <div className="container relative z-[1]">
              <div className="text-center lg:w-1/2 ltr:lg:text-left rtl:lg:text-right">
                ...
                <a href="career.html" className="btn capitalize text-white">
                  Join Our Team
                </a>
              </div>
            </div>
          ...
          <section className="relative py-14 lg:py-[100px] xl:-mt-[100px]">
            <div className="absolute top-0 z-[1] h-full w-full bg-white ltr:left-0 rtl:right-0 dark:bg-black xl:w-[85%] xl:rounded-r-[32px]" />
            <div className="absolute -top-3 hidden h-full w-full rounded-r-[32px] bg-white/50 ltr:left-3 rtl:right-3 dark:bg-gray-dark xl:inline-block xl:w-[85%]" />
            ...
            <div className="container">
              <div className="heading text-center lg:w-2/3 ltr:lg:text-left rtl:lg:text-right">
                ...
                <p className="text-lg leading-[23px]">
                  As the leading web &amp; mobile app development company have
                  been privileged to win
                  <span className="font-semibold text-black dark:text-white">
                    13+ numerous awards
                  </span>{" "}
                  for our working process. We’re honored to be a recipient of
                  each of these awards for our hard work &amp; customers
                  loyalty.
                </p>
              </div>
                  ...
                  <div className="swiper-slide">
                    <div className="relative rounded-3xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark">
                      ...
                      <div className="p-5 text-sm font-bold">
                        ...
                        <p className="line-clamp-4">
                          Jira works well for Agile development projects for
                          many reasons, including the ability to create Kanban
                          and Scrum boards with sprint planning and issue time
                    ...
                    <div className="relative rounded-3xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark">
                      ...
                      <div className="p-5 text-sm font-bold">
                        ...
                        <p className="line-clamp-4">
                          ...
                          the quality and quantity of website traffic to a
          ...
          <section className="relative bg-black pb-[100px] pt-14 dark:bg-transparent lg:pb-[250px] lg:pt-20">
            ...
            <div className="container">
              ...
              <div className="mx-auto lg:w-11/12">
                <div className="swiper mySwiper relative sm:py-12 md:py-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                        ...
                        <div className="col-span-2">
                          <div className="relative rounded-3xl bg-white/[0.02] p-6">
                            ...
                            <p className="relative font-medium italic text-white">
                              ...
                              believable.
                              <span className="absolute -top-2 ltr:-left-2 rtl:-right-2">
                                <svg
                                  width={100}
                                  height={73}
                                  viewBox="0 0 100 73"
          ...
          <section className="relative overflow-x-hidden border-t-2 border-transparent py-14 dark:border-gray/20 lg:py-[100px]">
            <div className="container">
              <div className="relative">
                ...
                >
                  <img
                    src="assets/images/stay-text.png"
                    alt="stay-text"
                    className="left-1/2 mx-auto sm:absolute sm:-translate-x-1/2"
                  />
                  <img
                    src="assets/images/updated-text.png"
                    alt="updated-text"

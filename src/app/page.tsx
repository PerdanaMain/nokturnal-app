...
import blogBanner from "./assets/images/blog/banner_bg.png";
import shaun from "./assets/images/blog/shaun.png";
import blog1 from "./assets/images/blog/blogs1.jpg";
import blog2 from "./assets/images/blog/blogs2.jpg";
import blog3 from "./assets/images/blog/blogs3.jpg";
import blog4 from "./assets/images/blog/blogs4.jpg";
import popular1 from "./assets/images/blog/popular1.jpg";
import popular2 from "./assets/images/blog/popular2.jpg";
import popular3 from "./assets/images/blog/popular3.jpg";
import popular4 from "./assets/images/blog/popular4.jpg";
    ...
    <>
      ...
      <div className="flex min-h-screen flex-col bg-white bg-gradient-to-r from-[#FCF1F4] to-[#EDFBF9] font-mulish text-base font-normal text-gray antialiased dark:bg-[#101926] dark:from-transparent dark:to-transparent">
        ...
        <div className="-mt-[82px] flex-grow overflow-x-hidden lg:-mt-[106px]">
          {/* Hero */}
          <section className="bg-black bg-[url(../images/blog/banner_bg.png)] bg-center bg-no-repeat pb-12 pt-36 text-white sm:pt-[200px] lg:pb-80">
              ...
              <div className="relative">
                <div className="text-center lg:max-w-[754px] ltr:lg:text-left rtl:lg:text-right">
                  <h2 className="text-3xl font-black sm:text-5xl md:text-6xl">
                    We help <span className="text-primary">digitally</span>{" "}
                    transform{" "}
                  ...
                  <p className="mt-7 text-base font-semibold xl:text-lg">
                    ...
                    form of a typeface without relying on very meaningful
                    content like this one for example.
                  </p>
                  <div className="mt-10 flex items-center justify-center gap-6 lg:justify-start">
                    <button
                      type="button"
                      className="btn bg-white py-[19px] shadow-[10px_15px_30px_rgba(199,128,161,0.2)]"
                    >
                      All Posts
                    </button>
                    <button
                      type="button"
                      className="btn py-[19px] px-8 text-white shadow-[10px_15px_30px_rgba(199,128,161,0.2)]"
                    >
                      Trending
                    </button>
                  </div>
                ...
                <div
                  className="top-0 mt-10 w-full max-w-[686px] ltr:right-0 rtl:left-0 lg:absolute"
                  data-aos="fade-left"
                  data-aos-duration={1000}
                >
                  <Image src={blogBanner} className="rtl:rotate-y-180" alt="" />
                </div>
              </div>
            </div>
          </section>
              ...
              >
                <div className="lg:max-w-[790px]">
                  <div className="flex gap-3">
                    <div className="h-[30px] w-[5px] bg-secondary" />
                    <h5 className="text-2xl font-extrabold text-black dark:text-white">
                      Latest Blogs
                    </h5>
                  </div>
                  <div className="mt-5 flex flex-col gap-4 rounded-[10px] border border-[#BBBBBB]/50 p-4 dark:border-[#7780A1]/20 md:flex-row">
                      ...
                      <div>
                        ...
                        <div className="mt-3 mb-4 flex gap-4">
                          <div className="flex items-center gap-3">
                            <Image src={shaun} className="w-9" alt="" />
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="border-b border-dashed border-gray opacity-50" />
                ...
                <div>
                  <div className="flex gap-4">
                    <div className="h-[30px] w-[5px] bg-primary" />
                    <h5 className="text-2xl font-extrabold text-black dark:text-white">
                      Popular Posts
                    </h5>
                  </div>
              ...
              >
                <div className="group relative h-[300px] flex-1 overflow-hidden rounded-[10px] sm:h-auto">
                  ...
                  <img
                    ...
                    alt=""
                  />
                  <h5 className="absolute top-5 rounded bg-primary py-1 px-2.5 text-[12px] font-extrabold text-white ltr:left-5 rtl:right-5">
                    TECH
                  </h5>
                  <div className="absolute bottom-4 left-5 right-5 z-[1] text-white">
                    ...
                    <p className="my-3 text-sm font-semibold">
                      Days fish waters gathered given made third under blessed,
                      is face. Is won’t lights it man can’t...
                    </p>
                  ...
                  <div className="group relative h-[263px] w-full overflow-hidden rounded-[10px] lg:max-w-[263px]">
                    ...
                    <div className="absolute bottom-4 left-5 right-5 z-[1] text-white">
                      <a
                        ...
                        className="text-[19px] font-bold duration-200 hover:text-secondary dark:hover:text-secondary"
                      >
                        Park’s Shinoda says ‘no way’ to a hologram Chester
                        Bennington
                      </a>
                      <div className="mt-[14px] flex items-center gap-2">
                        <span>
          ...
          {/* Stories */}
          <div className="bg-gradient-to-b from-white/60 to-transparent py-12 dark:bg-gradient-to-b dark:from-white/10 dark:to-transparent lg:py-24">
            <div className="container">
              <div className="mb-5 flex justify-between">
                ...
                <div className="flex gap-[14px]">
                  <span className="Stories-slider-button-prev flex h-[30px] w-[30px] items-center justify-center rounded-full bg-black/[0.04] text-[#08111F] duration-200 hover:bg-black hover:text-white rtl:rotate-y-180 dark:bg-white/[0.04] dark:text-white dark:hover:bg-secondary dark:hover:text-white">
                    <svg
                      width={7}
                      height={12}
                      viewBox="0 0 7 12"
                  ...
                  <span className="Stories-slider-button-next flex h-[30px] w-[30px] items-center justify-center rounded-full bg-black/[0.04] text-[#08111F] duration-200 hover:bg-black hover:text-white rtl:rotate-y-180 dark:bg-white/[0.04] dark:text-white dark:hover:bg-secondary dark:hover:text-white">
                    <svg
                      width={7}
                      height={12}
                      viewBox="0 0 7 12"
              ...
              <div className="rounded-[10px] border border-[#BBBBBB]/50 p-3 dark:border-[#7780A1]/20 sm:p-5">
                <div className="swiper Stories-slider">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="relative h-[346px] overflow-hidden rounded-[10px]">
                        <div className="absolute inset-0 bg-black/30" />
                        <img
                          src="assets/images/blog/stories1.jpg"
                          className="h-full w-full object-cover"
                          alt=""
                        />
                        <div className="absolute bottom-5 ltr:left-5 rtl:right-5">
                          <p className="inline-block rounded bg-primary py-1 px-2.5 text-[12px] font-extrabold text-white">
                            FASHION
                          </p>
                          <h5 className="mt-3 text-xl font-extrabold text-white">
                            16 Unheard Ways To Achieve Greater Walker
                          </h5>
                          <div className="mt-[14px] flex gap-4">
                            <div className="flex items-center gap-3">
                              <img
                                src="assets/images/blog/shaun.png"
                                className="w-9"
                                alt=""
                              />
                    ...
                    <div className="swiper-slide">
                      <div className="relative h-[346px] overflow-hidden rounded-[10px]">
                        <div className="absolute inset-0 bg-black/30" />
                        <img
                          src="assets/images/blog/stories2.jpg"
                          className="h-full w-full object-cover"
                          alt=""
                        />
                        <div className="absolute bottom-5 ltr:left-5 rtl:right-5">
                          <p className="inline-block rounded bg-secondary py-1 px-2.5 text-[12px] font-extrabold text-white">
                            TIPS
                          </p>
                          <h5 className="mt-3 text-xl font-extrabold text-white">
                    ...
                    <div className="swiper-slide">
                      <div className="relative h-[346px] overflow-hidden rounded-[10px]">
                        <div className="absolute inset-0 bg-black/30" />
                        <img
                          src="assets/images/blog/stories3.jpg"
                          className="h-full w-full object-cover"
                          alt=""
                        />
                        <div className="absolute bottom-5 ltr:left-5 rtl:right-5">
          ...
          <section className="relative bg-black py-12 dark:bg-[#1C2331] lg:py-24">
            <div className="absolute inset-0 bg-[url(../images/blog/newsletter.svg)] bg-center bg-repeat opacity-50" />
            <div className="container">
              <div className="relative z-[1] flex flex-col items-center justify-between gap-5 text-center lg:flex-row ltr:lg:text-left rtl:lg:text-right">
                <div>
                  <h2 className="text-3xl font-extrabold text-primary sm:text-[40px] sm:leading-[50px]">
                    JOIN OUR NEWSLETTER!
                  </h2>
          ...
          <section className="bg-gradient-to-b from-white/60 to-transparent py-12 dark:bg-none lg:py-24">
            <div className="container">
              <div className="mb-9 flex justify-between">
                ...
                <div className="flex gap-[14px]">
                  <span className="feedback-slider-button-prev flex h-[30px] w-[30px] items-center justify-center rounded-full bg-black/[0.04] text-[#08111F] duration-200 hover:bg-black hover:text-white rtl:rotate-y-180 dark:bg-white/[0.04] dark:text-white dark:hover:bg-secondary dark:hover:text-white">
                    <svg
                      width={7}
                      height={12}
                      viewBox="0 0 7 12"
                  ...
                  <span className="feedback-slider-button-next flex h-[30px] w-[30px] items-center justify-center rounded-full bg-black/[0.04] text-[#08111F] duration-200 hover:bg-black hover:text-white rtl:rotate-y-180 dark:bg-white/[0.04] dark:text-white dark:hover:bg-secondary dark:hover:text-white">
                    <svg
                      width={7}
                      height={12}
                      viewBox="0 0 7 12"
              ...
              <div className="swiper feedback-slider">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="relative h-[346px] overflow-hidden rounded-[10px]">
                      <img
                        src="assets/images/blog/celebration1.jpg"
                        className="h-full w-full object-cover"
                        alt=""
                      />
                      <p className="absolute top-5 rounded bg-secondary py-1 px-2.5 text-[12px] text-white ltr:left-5 rtl:right-5">
                        LIFESTYLE
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="swiper-slide">
                    <div className="relative h-[346px] overflow-hidden rounded-[10px]">
                      <img
                        src="assets/images/blog/celebration2.jpg"
                        className="h-full w-full object-cover"
                        alt=""
                      />
                      <p className="absolute top-5 rounded bg-primary py-1 px-2.5 text-[12px] text-white ltr:left-5 rtl:right-5">
                        TRAVEL
                      </p>
                    </div>
                    <div>
                      ...
                      <a
                        ...
                        className="text-lg font-extrabold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                      >
                        SuperShe Island: Women-only luxury retreat opening in
                        Finland
                      </a>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="relative h-[346px] overflow-hidden rounded-[10px]">
                      <img
                        src="assets/images/blog/celebration3.jpg"
                        className="h-full w-full object-cover"
                        alt=""
                      />
                      <p className="absolute top-5 rounded bg-primary py-1 px-2.5 text-[12px] text-white ltr:left-5 rtl:right-5">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                      <div className="relative overflow-hidden rounded-[10px]">
                        <div className="h-[150px]">
                          <img
                            src="assets/images/blog/recent1.jpg"
                            className="h-full w-full object-cover"
                            alt=""
                          />
                        </div>
                        <div className="bg-white p-3">
                          ...
                          <div className="mt-2 flex justify-between">
                            <div className="flex items-center gap-2.5">
                              <img
                                src="assets/images/blog/william1.png"
                                alt=""
                              />
                      ...
                      <div className="relative overflow-hidden rounded-[10px]">
                        <div className="h-[150px]">
                          <img
                            src="assets/images/blog/recent2.jpg"
                            className="h-full w-full object-cover"
                            alt=""
                          />
                        </div>
                        <div className="bg-white p-3">
                          ...
                          <p className="mt-2 mb-3 text-sm font-medium line-clamp-2">
                            No place is ever as bad as they tell you it’s going
                            to be.
                          </p>
                          <div className="border-b border-[#EFEFEF]" />
                          <div className="mt-2 flex justify-between">
                            <div className="flex items-center gap-2.5">
                              <img
                                src="assets/images/blog/william2.png"
                                alt=""
                              />
                      ...
                      <div className="relative overflow-hidden rounded-[10px]">
                        <div className="h-[150px]">
                          <img
                            src="assets/images/blog/recent3.jpg"
                            className="h-full w-full object-cover"
                            alt=""
                          />
                        </div>
                        <div className="bg-white p-3">
                          ...
                          <p className="mt-2 mb-3 text-sm font-medium line-clamp-2">
                            Travel makes you see what a tiny place you occupy in
                            the world.
                          </p>
                          <div className="border-b border-[#EFEFEF]" />
                          <div className="mt-2 flex justify-between">
                      ...
                      <div className="relative overflow-hidden rounded-[10px]">
                        <div className="h-[150px]">
                          <img
                            src="assets/images/blog/recent4.jpg"
                            className="h-full w-full object-cover"
                            alt=""
                          />
                        </div>
                  ...
                  <div className="flex-none lg:w-[470px]">
                    ...
                    <div className="space-y-6">
                      <div className="relative h-[306px] w-full overflow-hidden rounded-[10px]">
                        <div className="absolute inset-0 bg-gradient-to-b from-[#000]/5 via-[#000]/60 to-[#000]/75" />
                        <img
                          src="assets/images/blog/featured1.jpg"
                          className="h-full w-full object-cover"
                          alt=""
                        />
                        <div className="absolute bottom-5 left-5 right-5">
                          <a
                            href="javascript:"
                            className="text-xl font-bold text-white hover:text-secondary dark:hover:text-secondary"
                          >
                            The Road Ahead
                          </a>
                          ...
                          <div className="mt-3 border-b border-white/40" />
                      ...
                      <div className="relative h-[306px] overflow-hidden rounded-[10px]">
                        <div className="absolute inset-0 bg-gradient-to-b from-[#000]/5 via-[#000]/60 to-[#000]/75" />
                        <img
                          src="assets/images/blog/featured2.jpg"
                          className="h-full w-full object-cover"
                          alt=""
                        />
                        <div className="absolute bottom-5 left-5 right-5">
            ...
            <div className="container">
              <div className="grid grid-cols-2 justify-center gap-7 text-center md:grid-cols-4">
                <div>
                  ...
                  <h2
                    className="mt-5 text-[34px] font-black leading-10 text-black dark:text-white"
                ...
                <div>
                  <span>
                    ...
                    >
                      ...
                      />
                      <path
                        d="M45.8333 32.2916V36.4583"
                        stroke="#B476E5"
                        strokeWidth={3}
                        strokeLinecap="round"
                      />
                      <path
                        d="M4.16667 32.2916V36.4583"
                        stroke="#B476E5"
                        strokeWidth={3}
                        strokeLinecap="round"
                      />
                ...
                <div className="space-y-5 lg:max-w-[650px] xl:max-w-[726px]">
                  ...
                  <div className="mt-5 flex flex-col gap-6 sm:flex-row">
                    ...
                    <div>
                      ...
                      >
                        How 7 things will change the way you approach
                        photographs
                      </a>
                      ...
                      <p className="mt-3 text-sm font-medium">
                        Tincidunt dolor neque, risus aliquet ac cursus sodales
                        placerat. Elit, nisl convallis diam imperdiet feugiat.
                        Sagittis, neque commodo.
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-col gap-6 sm:flex-row">
                    ...
                    <div>
                      <div className="mb-[14px]">
                        <p className="inline-block rounded bg-primary py-1 px-2.5 text-[12px] font-extrabold leading-4 text-white">
                          DESIGN
                        </p>
                      </div>
                      <a
                      ...
                      <p className="mt-3 text-sm font-medium">
                        Turpis pulvinar quam nec porta faucibus blandit nulla
                        diam ut. Nisi, amet sit vitae mattis. Dictum enim dictum
                        quam pretium pretium.
                      </p>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-5 mb-5 flex gap-3">
                    <div className="relative max-w-[165px] overflow-hidden rounded-[10px]">
                      <img
                        src="assets/images/blog/videos1.jpg"
                        className="h-full w-full object-cover"
                        alt=""
                      />
                      <a
                  ...
                  <div className="border-b border-dashed border-gray/50" />
                  <div className="mt-5 mb-5 flex gap-3">
                    <div className="relative max-w-[165px] overflow-hidden rounded-[10px]">
                      <img
                        src="assets/images/blog/videos2.jpg"
                        className="h-full w-full object-cover"
                        alt=""
                      />
                      <a
                    ...
                    <div>
                      ...
                      >
                        An Exciting Car Representing Aston Future
                      </a>
                    </div>
                  </div>
                  <div className="border-b border-dashed border-gray/50" />
                  <div className="mt-5 flex gap-3">
                    <div className="relative max-w-[165px] overflow-hidden rounded-[10px]">
                      <img
                        src="assets/images/blog/videos3.jpg"
                        className="h-full w-full object-cover"
                        alt=""
                      />
                      <a
      ...
      <button
        type="button"
        id="scrollToTopBtn"
        className="fixed bottom-5 z-10 hidden animate-bounce ltr:right-5 rtl:left-5"
        // onclick="scrollToTop()"
      >
